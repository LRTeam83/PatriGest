    ...
    <footer className="border-t border-[#E2E8F0] bg-white">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-5 py-10 sm:px-8 lg:flex-row lg:items-end lg:justify-between lg:px-10">
        ...
        <nav className="flex flex-wrap gap-x-6 gap-y-3 text-sm font-semibold text-[#64748B]" aria-label="Navigation de pied de page">
          <a className="focus-ring rounded-md hover:text-[#2563EB]" href="#fonctionnalites">Fonctionnalités</a>
          <a className="focus-ring rounded-md hover:text-[#2563EB]" href="#comment-ca-marche">Comment ça marche</a>
          <a className="focus-ring rounded-md hover:text-[#2563EB]" href="#compte-de-gestion">Compte de gestion</a>
