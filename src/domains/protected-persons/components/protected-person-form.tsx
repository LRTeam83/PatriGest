...
export function ProtectedPersonForm() {
  ...
  return (
    <form action={action} className="space-y-4">
      <fieldset><legend className="text-base font-bold">Identité</legend><div className="mt-2.5 grid gap-3 sm:grid-cols-2">
      ...
      <fieldset><legend className="text-base font-bold">Coordonnées</legend><div className="mt-2.5 grid gap-3 sm:grid-cols-2">
